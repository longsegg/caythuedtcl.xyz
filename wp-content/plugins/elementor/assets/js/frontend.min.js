...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    var i = n(8),
      ...
      ee = function getOwnPropertySymbols(e) {
        for (
          var t, n = e === Q, i = T(n ? N : w(e)), o = [], s = 0;
          i.length > s;

        )
          !r(B, (t = i[s++])) || (n && !r(Q, t)) || o.push(B[t]);
        return o;
      };
    z ||
      (a(
  ...
  function (e, t, n) {
    n(25) &&
      "g" != /./g.flags &&
      n(44).f(RegExp.prototype, "flags", { configurable: !0, get: n(110) });
  },
  ,
  ,
  ,
      ...
      getSlideshowHeader: function getSlideshowHeader() {
        ...
        if (t || n || i || r) {
          if (
            ...
            t &&
              ((a.$counter = e("<span>", { class: s.counter })),
              a.$header.append(a.$counter)),
            n &&
              ((a.$iconExpand = e("<i>", { class: s.iconExpand }).append(
                e("<span>"),
                e("<span>")
              )),
              a.$iconExpand.on("click", this.toggleFullscreen),
              a.$header.append(a.$iconExpand)),
            i &&
              ((a.$iconZoom = e("<i>", { class: s.iconZoomIn })),
              a.$iconZoom.on("click", this.toggleZoomMode),
              a.$header.append(a.$iconZoom)),
            r)
          ) {
      ...
      setSlideshowContent: function setSlideshowContent(e) {
        ...
        e.slides.forEach(function (e) {
          ...
          if (e.video) {
            ...
            var i = r("<div>", { class: u.playButton }).html(
              r("<i>", { class: u.playButtonIcon })
            );
            n.append(i);
          } else {
          ...
          o ||
            ...
            }).html(r("<i>", { class: c.prevButtonIcon }))),
            (n = r("<div>", {
              class: c.nextButton + " " + u.preventClose,
            }).html(r("<i>", { class: c.nextButtonIcon }))),
            d.append(t, n)),
          l &&
        ...
        if (this.isLightboxLink(t)) {
          if (
            ...
            if (
              ...
              this.openSlideshow(t.dataset.elementorLightboxSlideshow, t.href);
            else {
              this.showModal({
                type: "image",
                id: "single-img",
