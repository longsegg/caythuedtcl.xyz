!(function () {
  ...
  if ("querySelector" in document && "addEventListener" in window) {
    ...
    for (
      var d = document.querySelectorAll(".menu-toggle"),
        e = document.querySelectorAll("nav .dropdown-menu-toggle"),
        t = document.querySelectorAll("nav ul a"),
        c = document.body,
        u = document.documentElement,
        o = function (e, t) {
          if (!t) t = this;
          if (t.getAttribute("data-nav"))
            var o = document.getElementById(t.getAttribute("data-nav"));
          ...
          if (o.classList.contains("toggled")) {
            if (
              ...
              c.classList.contains("dropdown-hover"))
            )
              for (
                var r = n.querySelectorAll("li.menu-item-has-children"), l = 0;
                l < r.length;
                l++
              )
                r[l]
            ...
            for (
              r = n.querySelectorAll("li.menu-item-has-children"), l = 0;
              l < r.length;
              l++
            )
              r[l]
      ...
      d[n].addEventListener("click", o, !1);
    var r = function (e, t) {
      if (!t) t = this;
      if (
        (t.closest("nav").classList.contains("toggled") ||
          u.classList.contains("slide-opened")) &&
        !c.classList.contains("dropdown-click")
      ) {
        e.preventDefault();
        var o = t.closest("li"),
        ...
        if (
          ...
          var r = o.querySelector(".sub-menu");
    ...
    for (n = 0; n < e.length; n++)
      e[n].addEventListener("click", r, !1),
        ...
        if (null === d[e].offsetParent) {
          ...
          if (t && t.classList.contains("toggled")) {
            ...
            for (var s = 0; s < r.length; s++)
              r[s].classList.remove("toggled-on");
            if (
              (o && o.removeAttribute("aria-hidden"),
              c.classList.contains("dropdown-hover"))
            )
              for (
                var i = t.querySelectorAll("li.menu-item-has-children"), a = 0;
                a < i.length;
                a++
              )
                i[a]
