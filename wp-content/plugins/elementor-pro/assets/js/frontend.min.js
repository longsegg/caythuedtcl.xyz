        ...
        function t() {
          ...
          return (
            ...
            (0, d.default)((0, a.default)(n), "onInsideViewport", function () {
              n.run(),
                (n.animationFrameRequest = requestAnimationFrame(
                  n.onInsideViewport
                ));
            }),
            n
    ...
    var i = n(0),
      ...
      p = (function (e) {
        function t() {
          return (
            (0, s.default)(this, t),
            (0, r.default)(this, (0, a.default)(t).apply(this, arguments))
          );
        }
        return (
          (0, u.default)(t, e),
              ...
              value: function () {
                ...
                this.getModal = function () {
                  if (!e) {
                    ...
                    t.isEdit && (r.off("click"), (e.hide = function () {})),
      ...
      c = (function (e) {
        function t() {
          ...
          return (
            ((n = (0, r.default)(
              this,
              (e = (0, a.default)(t)).call.apply(e, [this].concat(o))
            )).checkScroll = n.checkScroll.bind((0, l.default)(n))),
            (n.lastScrollOffset = 0),
            n
          );
        }
        return (
        ...
        function t() {
          ...
          return (
            ((n = (0, r.default)(
              this,
              (e = (0, a.default)(t)).call.apply(e, [this].concat(o))
            )).checkClick = n.checkClick.bind((0, l.default)(n))),
            (n.clicksCount = 0),
            n
          );
        }
        ...
        function t() {
          ...
          return (
            ((n = (0, r.default)(
              this,
              (e = (0, a.default)(t)).call.apply(e, [this].concat(o))
            )).restartTimer = n.restartTimer.bind((0, l.default)(n))),
            n
          );
        }
        return (
        ...
        function t() {
          ...
          return (
            ((n = (0, r.default)(
              this,
              (e = (0, a.default)(t)).call.apply(e, [this].concat(o))
            )).detectExitIntent = n.detectExitIntent.bind((0, l.default)(n))),
            n
          );
        }
        return (
                  ...
                  jQuery.each(t.interactions, function (t, n) {
                    (e.interactions[t] = new e.interactionsTypes[t]({
                      ...
                      callback: function () {
                        ...
                        jQuery.each(n, function (t, n) {
                          var s;
                          return (s = e.actions).runAction.apply(
                            s,
                            [t, n].concat(i)
                          );
                        });
              ...
              value: function () {
                ...
                (e =
                  "page" === this.motionFX.getSettings("range")
                    ...
                    : c.default.getElementViewportPercentage(
            ...
            },
            {
              ...
              value: function () {
                ...
                var i = elementorFrontend.getDeviceSetting(
                  ...
                  s = elementorFrontend.getDeviceSetting(
                    "tablet",
                    e,
                    "ideal_row_height"
                  ),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.elements.$headings.before(function (t) {
                  return '<span id="'
                    .concat(e.headingAnchor, "-")
                    .concat(t, '" class="')
                    .concat(e.anchor, ' "></span>');
                });
              },
            },
            {
                  ...
                  elementorFrontend.waypoint(
                    ...
                    function (s) {
                      if (!i.itemClicked) {
                        ...
                        "down" === s
                          ? (delete i.viewportItems[o],
                            Object.keys(i.viewportItems).length &&
                              i.activateItem(i.$listItemTexts.eq(t + 1)))
                          : ((i.viewportItems[o] = !0), i.activateItem(e));
                      }
                    },
              ...
              value: function (e) {
                for (
                  ...
                  if (e === o.level) {
                    ...
                    var a = '<a href="#'
                      .concat(t.classes.headingAnchor, "-")
    ...
    var i = elementorModules.frontend.handlers.Base.extend({
      ...
      hideWord: function (e) {
        ...
        if ("typing" === o)
          ...
          t.hideLetter(e.find(s).eq(0), e, a, n.lettersDelay),
            t.showLetter(r.find(s).eq(0), r, a, n.lettersDelay),
    ...
    (i = s.extend({
      ...
      getElementSettings: function (e) {
        return (
          -1 !== this.slideshowSpecialElementSettings.indexOf(e) &&
            this.isSlideshow() &&
            (e = "slideshow_" + e),
          s.prototype.getElementSettings.call(this, e)
        );
      },
      getDefaultElements: function () {
        var e = this.getSettings("selectors"),
      ...
      getEffect: function () {
        return "coverflow" === this.getElementSettings("skin")
          ? "coverflow"
          : s.prototype.getEffect.apply(this, arguments);
      },
      getSlidesPerView: function (e) {
        return this.isSlideshow()
          ...
          ? this.getDeviceSlidesPerView(e)
          : s.prototype.getSlidesPerView.apply(this, arguments);
      },
      getSwiperOptions: function () {
  ...
  function (e, t, n) {
    ...
    var i = elementorModules.frontend.handlers.Base.extend({
      ...
      getTimeRemaining: function (e) {
        ...
        return (
          (o < 0 || s < 0 || i < 0) && (n = i = s = o = 0),
          { total: t, parts: { days: o, hours: s, minutes: i, seconds: n } }
        );
      },
            ...
            },
            {
              ...
              value: function () {
                ...
                this.elements.$stepWrapper.each(function (n, i) {
                  ...
                  n
                    ? (r.append(e.getStepButton("previous", n)),
                      (s =
                        n === t - 1
                          ? e.getSubmitButton()
                          : e.getStepButton("next", n)))
                    : (s = e.getStepButton("next", n)),
                    r.append(s),
                    o.append(r);
                });
              },
