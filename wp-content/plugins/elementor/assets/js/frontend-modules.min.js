        ...
        [
          ...
          function (t, e) {
            ...
            for (var x = 0, b = 0, S = []; b < p.length; ) {
              ...
              if (
                null === O ||
                (w = l(c(m.lastIndex + (h ? 0 : b)), p.length)) === x
              )
                b = u(p, b, g);
              else {
      ...
      function (t, e, n, l, p) {
        ...
        if (i(y)) {
          for (v = c(t.length); v > _; _++)
            if ((g = e ? m(u((h = t[_]))[0], h[1]) : m(t[_])) === a || g === f)
              return g;
        } else
  ...
  function (t, e, n) {
    ...
    var r = n(8),
      ...
      Y = function propertyIsEnumerable(t) {
        ...
        return (
          !(this === H && o(W, t) && !o(G, t)) &&
          (!(e || !o(this, t) || !o(W, t) || (o(this, N) && this[N][t])) || e)
        );
      },
      X = function getOwnPropertyDescriptor(t, e) {
        if (((t = b(t)), (e = S(e, !0)), t !== H || !o(W, e) || o(G, e))) {
          var n = I(t, e);
          return (
            !n || !o(W, e) || (o(t, N) && t[N][e]) || (n.enumerable = !0), n
          );
        }
      },
      Z = function getOwnPropertyNames(t) {
        for (var e, n = L(b(t)), r = [], i = 0; n.length > i; )
          o(W, (e = n[i++])) || e == N || e == s || r.push(e);
        return r;
      },
      tt = function getOwnPropertySymbols(t) {
        for (
          var e, n = t === H, r = L(n ? G : b(t)), i = [], u = 0;
          r.length > u;

        )
          !o(W, (e = r[u++])) || (n && !o(H, e)) || i.push(W[e]);
        return i;
      };
    V ||
      (c(
