/(trident|msie)/i.test(navigator.userAgent) &&
  ...
  (function () {
    ...
    if (
      ...
      for (
        var e = document.querySelectorAll("nav .main-nav ul a"),
          t = function () {
            if (
        ...
        e[s].addEventListener("focus", t), e[s].addEventListener("blur", t);
    if (
      ...
      for (s = 0; s < n.length; s++)
        n[s].addEventListener("touchend", function (e) {
          if (
            !(
              this.closest("nav").classList.contains("toggled") ||
            ...
            if (
              t &&
              !this.closest("ul").classList.contains("toggled-on") &&
              !this.closest("li").classList.contains("sfHover")
            )
              for (var s = 0; s < t.length; s++)
                t[s].classList.remove("toggled-on"),
                  t[s].closest("li").classList.remove("sfHover");
