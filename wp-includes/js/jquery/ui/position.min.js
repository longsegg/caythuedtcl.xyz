        ...
        (I.ui.position = {
          fit: {
            left: function (t, i) {
              ...
              i.collisionWidth > n
                ? 0 < f && s <= 0
                  ? ((e = t.left + f + i.collisionWidth - n - o),
                    (t.left += f - e))
                  : (t.left =
                      !(0 < s && f <= 0) && s < f
                        ? o + n - i.collisionWidth
                        : o)
                : 0 < f
                ? (t.left += f)
                : 0 < s
                ? (t.left -= s)
                : (t.left = x(t.left - l, t.left));
            },
            top: function (t, i) {
              var e = i.within,
              ...
              i.collisionHeight > n
                ? 0 < f && s <= 0
                  ? ((e = t.top + f + i.collisionHeight - n - o),
                    (t.top += f - e))
                  : (t.top =
                      !(0 < s && f <= 0) && s < f
                        ? o + n - i.collisionHeight
                        : o)
                : 0 < f
                ? (t.top += f)
                : 0 < s
                ? (t.top -= s)
                : (t.top = x(t.top - l, t.top));
            },
          },
          flip: {
            left: function (t, i) {
              var e = i.within,
                ...
                f = -2 * i.offset[0];
              s < 0
                ? ((o = t.left + r + e + f + i.collisionWidth - n - o) < 0 ||
                    o < T(s)) &&
                  (t.left += r + e + f)
                : 0 < h &&
                  (0 <
            ...
            top: function (t, i) {
              var e = i.within,
                ...
                f = -2 * i.offset[1];
              s < 0
                ? ((o = t.top + r + e + f + i.collisionHeight - n - o) < 0 ||
                    o < T(s)) &&
                  (t.top += r + e + f)
                : 0 < h &&
                  (0 <
                    (l =
                      t.top - i.collisionPosition.marginTop + r + e + f - l) ||
                    T(l) < h) &&
                  (t.top += r + e + f);
            },
          },
